...
`KeyRateZero` is less commonly reported (than [`KeyRatePar`](@ref)) in the fixed income markets, even though it has more analytically attractive properties. See the discussion of KeyRateDuration in the FinanceModels.jl docs.
"""
